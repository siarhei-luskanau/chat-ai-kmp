...
object AnswerVerificationTool : SimpleTool<AnswerVerificationTool.Args>() {
    ...
    data class Args(
        ...
        @property:LLMDescription(
            "Confidence level in the verification (1-100, where 100 is highest confidence)"
        )
    ...
    override suspend fun doExecute(args: Args): String =
        "Answer verification completed for: '${args.answer}', confidence level: ${args.confidence ?: "not specified"}"
}
