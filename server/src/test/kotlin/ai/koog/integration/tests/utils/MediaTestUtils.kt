...
object MediaTestUtils {
    ...
    fun createVideoFileForScenario(testResourcesDir: Path): Path = testResourcesDir.resolve("video.mp4")
    ...
    fun checkExecutorMediaResponse(response: Message.Response) {
        ...
        assertFalse(
            responseLowerCase.contains("error processing"),
        ...
        assertFalse(
            responseLowerCase.contains("cannot process"),
            "Result should not indicate inability to process"
        )
    }
